...
export const CHAT_HEADER: string = `FitGenius`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by Giovanna Chen for COMP488`;
export const CLEAR_BUTTON_TEXT: string = `Erase and Start Fresh?`;
export const PAGE_TITLE: string = `FitGenius`;
